...
# Generated: Wed Mar 22 01:10:46 2017
##################################################
...
class test_corr_and_sync(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_1_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0, 0, 0, "")
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_0_win, 1,0,1,2)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_win, 10,0,1,2)
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
        	5000, #size
        	samp_rate, #samp_rate
        	"DOWNCONVERTED_TIME", #name
        	1 #number of inputs
        )
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
        	256, #size
        	"DOWNCOVERTED_CONSTELLATION", #name
        	1 #number of inputs
        )
        ...
        self.blocks_tagged_stream_mux_0 = blocks.tagged_stream_mux(gr.sizeof_char*1, "START_PACKET", 0)
        self.blocks_stream_to_tagged_stream_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 32000, "START_PACKET")
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 8, "START_PACKET")
        ...
        self.connect((self.blocks_complex_to_mag_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))    
        ...
        self.connect((self.digital_constellation_modulator_0, 0), (self.blocks_complex_to_mag_0_0, 0))    
...
def main(top_block_cls=test_corr_and_sync, options=None):
