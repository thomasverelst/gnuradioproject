...
# Generated: Tue Apr 25 22:42:04 2017
##################################################
...
class basic_chain_custom2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_1_0_0_1_2.enable_axis_labels(True)
        ...
        self.qtgui_time_sink_x_0_1_0_0_1_0_0 = qtgui.time_sink_c(
        	1024, #size
        	samp_rate, #samp_rate
        	"RX  Demux Paylaod Stream", #name
        	1 #number of inputs
        )
        self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_y_axis(-100, 100)

        self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_1_0_0_1_0_0.enable_tags(-1, True)
        self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "")
        self.qtgui_time_sink_x_0_1_0_0_1_0_0.enable_autoscale(False)
        self.qtgui_time_sink_x_0_1_0_0_1_0_0.enable_grid(False)
        self.qtgui_time_sink_x_0_1_0_0_1_0_0.enable_axis_labels(True)
        self.qtgui_time_sink_x_0_1_0_0_1_0_0.enable_control_panel(False)

        if not True:
          self.qtgui_time_sink_x_0_1_0_0_1_0_0.disable_legend()
        ...
        for i in xrange(2):
            if len(labels[i]) == 0:
                if(i % 2 == 0):
                    self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_line_label(i, "Re{{Data {0}}}".format(i/2))
                else:
                    self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_line_label(i, "Im{{Data {0}}}".format(i/2))
            else:
                self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_line_label(i, labels[i])
            self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_line_width(i, widths[i])
            self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_line_color(i, colors[i])
            self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_line_style(i, styles[i])
            self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_line_marker(i, markers[i])
            self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_line_alpha(i, alphas[i])

        self._qtgui_time_sink_x_0_1_0_0_1_0_0_win = sip.wrapinstance(self.qtgui_time_sink_x_0_1_0_0_1_0_0.pyqwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_time_sink_x_0_1_0_0_1_0_0_win)
        ...
        self.packetizr_preamble_header_payload_demux_0_0 =  packetizr.preamble_header_payload_demux(32/constel_header.bits_per_symbol(), 64, 1, 0, "packet_len", "packet_len", True, gr.sizeof_gr_complex, "rx_time", samp_rate, ("phase_est", "time_est"), 0)
        ...
        self.digital_constellation_soft_decoder_cf_0_0 = digital.constellation_soft_decoder_cf(constel_payload.base())
        self.digital_constellation_decoder_cb_0_1 = digital.constellation_decoder_cb(constel_header.base())
        ...
        self.blocks_repack_bits_bb_2_0 = blocks.repack_bits_bb(constel_header.bits_per_symbol(), 8, "", False, gr.GR_LSB_FIRST)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.digital_packet_headerparser_b_0_0, 'header_data'), (self.packetizr_preamble_header_payload_demux_0_0, 'header_data'))
        ...
        self.connect((self.blocks_char_to_float_1_1, 0), (self.blocks_delay_0, 0))
        ...
        self.connect((self.blocks_repack_bits_bb_1, 0), (self.blocks_char_to_float_1_1, 0))
        self.connect((self.blocks_repack_bits_bb_2_0, 0), (self.digital_packet_headerparser_b_0_0, 0))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.packetizr_preamble_header_payload_demux_0_0, 0))
        ...
        self.connect((self.digital_binary_slicer_fb_0_0, 0), (self.blocks_repack_bits_bb_1, 0))
        self.connect((self.digital_constellation_decoder_cb_0_1, 0), (self.blocks_repack_bits_bb_2_0, 0))
        self.connect((self.digital_constellation_soft_decoder_cf_0_0, 0), (self.digital_binary_slicer_fb_0_0, 0))
        self.connect((self.digital_costas_loop_cc_1, 0), (self.digital_constellation_soft_decoder_cf_0_0, 0))
        self.connect((self.digital_costas_loop_cc_1, 0), (self.qtgui_const_sink_x_0_0_0, 0))
        self.connect((self.digital_costas_loop_cc_1_0, 0), (self.digital_constellation_decoder_cb_0_1, 0))
        ...
        self.connect((self.packetizr_preamble_header_payload_demux_0_0, 1), (self.digital_costas_loop_cc_1, 0))
        self.connect((self.packetizr_preamble_header_payload_demux_0_0, 0), (self.digital_costas_loop_cc_1_0, 0))
        self.connect((self.packetizr_preamble_header_payload_demux_0_0, 1), (self.qtgui_time_sink_x_0_1_0_0_1_0_0, 0))
        self.connect((self.packetizr_preamble_header_payload_demux_0_0, 0), (self.qtgui_time_sink_x_0_1_0_0_1_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0_1_0_0_1_0_0.set_samp_rate(self.samp_rate)
