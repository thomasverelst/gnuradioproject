...
class tagged_stream_whiten_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tagged Stream Whiten Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tagged Stream Whiten Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tagged_stream_whiten_test")
        ...
        self.packetizr_tagged_whiten_1 = packetizr.tagged_whiten(True, (), bpb, "packet_len")
        self.packetizr_tagged_whiten_0 = packetizr.tagged_whiten(True, (), bpb, "packet_len")
        ...
        self.connect((self.packetizr_tagged_whiten_0, 0), (self.blocks_repack_bits_bb_0_0, 0))
        self.connect((self.packetizr_tagged_whiten_0, 0), (self.packetizr_tagged_whiten_1, 0))
        self.connect((self.packetizr_tagged_whiten_1, 0), (self.blocks_uchar_to_float_0, 0))
...
def main(top_block_cls=tagged_stream_whiten_test, options=None):
