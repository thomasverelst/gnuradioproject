...
class test_fec(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, frame_size=60, puncpat='11'):
        ...
        self.qtgui_time_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 0.5, 0, 0, "packet_len")
        ...
        self.blocks_tagged_stream_multiply_length_0 = blocks.tagged_stream_multiply_length(gr.sizeof_float*1, "packet_len", 2)
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, packlen, "packet_len")
        self.blocks_repack_bits_bb_0_1_1_0 = blocks.repack_bits_bb(1, constel.bits_per_symbol(), "packet_len", False, gr.GR_MSB_FIRST)
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(constel.bits_per_symbol(), 1, "packet_len", False, gr.GR_MSB_FIRST)
