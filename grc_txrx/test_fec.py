...
class test_fec(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, frame_size=60, puncpat='11'):
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.blocks_char_to_float_0_1, 0))
        ...
        self.connect((self.fec_extended_tagged_decoder_0, 0), (self.blocks_char_to_float_0, 0))
        self.connect((self.fec_extended_tagged_encoder_0, 0), (self.digital_map_bb_0_0, 0))
