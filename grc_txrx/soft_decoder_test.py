...
# Title: Soft Decoder Test
# Generated: Sun May 14 14:00:47 2017
##################################################
...
class soft_decoder_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Soft Decoder Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Soft Decoder Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "soft_decoder_test")
...
def main(top_block_cls=soft_decoder_test, options=None):
