...
# Generated: Sat Apr  8 21:46:41 2017
##################################################
...
class basic_chain_custom_othersync(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.variable_modulate_vector2_0 = variable_modulate_vector2_0 = packetizr.modulate_vector_cc(rxmod .to_basic_block(), preamble)
        ...
        self.qtgui_time_sink_x_0_1_0_0_1_2_0.enable_axis_labels(True)
    ...
    def set_preamble(self, preamble):
        ...
        self.blocks_stream_to_tagged_stream_1.set_packet_len(64/constel_header.bits_per_symbol()+len(self.preamble))
        self.blocks_stream_to_tagged_stream_1.set_packet_len_pmt(64/constel_header.bits_per_symbol()+len(self.preamble))

    def get_variable_modulate_vector2_0(self):
        return self.variable_modulate_vector2_0

    def set_variable_modulate_vector2_0(self, variable_modulate_vector2_0):
        self.variable_modulate_vector2_0 = variable_modulate_vector2_0
