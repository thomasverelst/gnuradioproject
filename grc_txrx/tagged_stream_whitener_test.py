...
# Generated: Sun May 14 14:46:30 2017
##################################################
...
class tagged_stream_whitener_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, frame_size=60, puncpat='11'):
        ...
        self.fec_extended_tagged_decoder_0 = self.fec_extended_tagged_decoder_0 = fec_extended_tagged_decoder_0 = fec.extended_tagged_decoder(decoder_obj_list=dec_cc, ann=None, puncpat='11', integration_period=10000, lentagname="packet_len", mtu=4)
        ...
        self.connect((self.fec_extended_tagged_decoder_0, 0), (self.blocks_uchar_to_float_0, 0))
