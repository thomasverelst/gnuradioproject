...
# Title: Basic Chain
# Generated: Sat Mar 25 15:15:48 2017
##################################################
...
class basic_chain(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.header_formatter = header_formatter = digital.packet_header_default(16, "packet_len", "packet_num", 1)
        ...
        self.packetizr_packet_encoder_0 = packetizr.packet_encoder(1, (), constel_header.base(), constel_payload.base(), 1, "packet_len")
        ...
        self.blocks_repack_bits_bb_0_2_0 = blocks.repack_bits_bb(constel_payload.bits_per_symbol(), 8, "", False, gr.GR_LSB_FIRST)
        ...
        self.connect((self.analog_random_source_x_0_0, 0), (self.blocks_repack_bits_bb_0_1_0, 0))    
        ...
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.packetizr_packet_encoder_0, 1))    
        self.connect((self.blocks_repack_bits_bb_0_1_0, 0), (self.blocks_stream_to_tagged_stream_0_1, 0))    
        self.connect((self.blocks_repack_bits_bb_0_2_0, 0), (self.digital_packet_headergenerator_bb_0_0, 0))    
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0_1, 0), (self.blocks_repack_bits_bb_0_2_0, 0))    
        ...
        self.connect((self.digital_packet_headergenerator_bb_0_0, 0), (self.packetizr_packet_encoder_0, 0))    
    ...
    def set_constel_payload(self, constel_payload):
        ...
        self.blocks_repack_bits_bb_0_2_0.set_k_and_l(self.constel_payload.bits_per_symbol(),8)
