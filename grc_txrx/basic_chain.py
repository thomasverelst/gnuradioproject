...
# Title: Basic Chain
# Generated: Sat Mar 25 23:00:50 2017
##################################################
...
class basic_chain(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_char_to_float_2, 0), (self.qtgui_time_sink_x_0_2_0, 0))    
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0_1, 0), (self.blocks_char_to_float_2, 0))    
