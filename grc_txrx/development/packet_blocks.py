...
class packet_blocks(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_interleaved_char_to_complex_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.blocks_interleaved_char_to_complex_0, 0))
