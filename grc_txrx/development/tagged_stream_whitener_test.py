...
# Title: Tagged Stream Whitener Test
# Generated: Fri Apr 28 21:42:02 2017
##################################################
...
class tagged_stream_whitener_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tagged Stream Whitener Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tagged Stream Whitener Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tagged_stream_whitener_test")
        ...
        self.packetizr_tagged_whitener_0_0 = packetizr.tagged_whitener(True, (), 8, "packet_len")
        self.packetizr_tagged_whitener_0 = packetizr.tagged_whitener(True, (), 8, "packet_len")
        ...
        self.connect((self.blocks_repack_bits_bb_0_1, 0), (self.packetizr_tagged_whitener_0, 0))
        ...
        self.connect((self.packetizr_tagged_whitener_0, 0), (self.blocks_repack_bits_bb_0_0, 0))
        self.connect((self.packetizr_tagged_whitener_0, 0), (self.packetizr_tagged_whitener_0_0, 0))
        self.connect((self.packetizr_tagged_whitener_0_0, 0), (self.blocks_uchar_to_float_0, 0))
...
def main(top_block_cls=tagged_stream_whitener_test, options=None):
