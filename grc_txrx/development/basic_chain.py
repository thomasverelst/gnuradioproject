...
# Title: Basic Chain
# Generated: Sun May 14 14:22:50 2017
##################################################
...
class basic_chain(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.header_formatter = header_formatter = digital.packet_header_default(32, "packet_len", "packet_num", constel_header.bits_per_symbol())
        ...
        self.connect((self.digital_header_payload_demux_0, 1), (self.digital_constellation_soft_decoder_cf_0, 0))
