...
# Title: Basic Chain Debug
# Generated: Wed Mar 22 00:12:20 2017
##################################################
...
class basic_chain_debug(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Basic Chain Debug")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basic Chain Debug")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "basic_chain_debug")
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_c(preamble, False, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_b((12,156,201,46,59,112,27,99,85,65,33), True, 1, [])
        ...
        self.blocks_stream_to_tagged_stream_0_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_gr_complex, 1, 40, "packet_len")
        ...
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(8, constel_payload.bits_per_symbol(), "packet_len", False, gr.GR_LSB_FIRST)
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0_0, 0), (self.blocks_vector_sink_x_0, 0))    
    ...
    def set_constel_header(self, constel_header):
        ...
        self.digital_chunks_to_symbols_xx_0.set_symbol_table((self.constel_header.points()))
    ...
    def set_constel_payload(self, constel_payload):
        ...
        self.blocks_repack_bits_bb_0.set_k_and_l(8,self.constel_payload.bits_per_symbol())
        self.digital_chunks_to_symbols_xx_0_0.set_symbol_table((self.constel_payload.points()))


def main(top_block_cls=basic_chain_debug, options=None):
    ...
    result_data = tb.blocks_vector_sink_x_0.data ()
