...
# Title: Basic Enc Dec Custom
# Generated: Sat Apr 29 12:24:50 2017
##################################################
...
class basic_enc_dec_custom(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Basic Enc Dec Custom")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basic Enc Dec Custom")
        ...
        self.settings = Qt.QSettings("GNU Radio", "basic_enc_dec_custom")
...
def main(top_block_cls=basic_enc_dec_custom, options=None):
