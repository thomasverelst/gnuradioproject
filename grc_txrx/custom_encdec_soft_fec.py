...
# Title: Custom Encdec Soft Fec
# Generated: Sun Apr 30 01:10:01 2017
##################################################
...
class custom_encdec_soft_fec(gr.top_block, Qt.QWidget):

    def __init__(self, frame_size=60, puncpat='11'):
        gr.top_block.__init__(self, "Custom Encdec Soft Fec")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Custom Encdec Soft Fec")
        ...
        self.settings = Qt.QSettings("GNU Radio", "custom_encdec_soft_fec")
        ...
        self._packlen_range = Range(1, 4096, 1, 64, 100)
        ...
        self.fec_tagged_encoder_0 = fec.tagged_encoder(enc_cc, gr.sizeof_char, gr.sizeof_char, "packet_len", 1500)
        self.fec_tagged_decoder_0 = fec.tagged_decoder(dec_cc, gr.sizeof_char, gr.sizeof_char,  "packet_len", 1500)
        ...
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(constel_payload.bits_per_symbol(), 8, "packet_len", False, gr.GR_LSB_FIRST)
        ...
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.fec_tagged_encoder_0, 0))
        ...
        self.connect((self.fec_tagged_decoder_0, 0), (self.blocks_uchar_to_float_0_0, 0))
        self.connect((self.fec_tagged_encoder_0, 0), (self.blocks_repack_bits_bb_0, 0))
        self.connect((self.fec_tagged_encoder_0, 0), (self.blocks_repack_bits_bb_0_0_0, 0))
        self.connect((self.packetizr_packet_decoder_0, 0), (self.blocks_null_sink_0, 0))
...
def main(top_block_cls=custom_encdec_soft_fec, options=None):
    if options is None:
