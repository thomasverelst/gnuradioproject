...
# Title: Custom Encdec Crc
# Generated: Sun Apr 30 01:44:33 2017
##################################################
...
class custom_encdec_crc(gr.top_block, Qt.QWidget):

    def __init__(self, frame_size=60, puncpat='11'):
        gr.top_block.__init__(self, "Custom Encdec Crc")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Custom Encdec Crc")
        ...
        self.settings = Qt.QSettings("GNU Radio", "custom_encdec_crc")
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0_1, 0), (self.blocks_char_to_float_1_0_0_0, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0_1, 0), (self.digital_crc32_bb_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.packetizr_packet_decoder_0, 0))
        self.connect((self.digital_crc32_bb_0, 0), (self.packetizr_packet_encoder_0, 0))
        self.connect((self.digital_crc32_bb_0_0, 0), (self.blocks_char_to_float_1_0_0, 0))
        self.connect((self.packetizr_packet_decoder_0, 0), (self.digital_crc32_bb_0_0, 0))
...
def main(top_block_cls=custom_encdec_crc, options=None):
    if options is None:
