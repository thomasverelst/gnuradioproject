...
# Title: Basic Encdec Soft
# Generated: Sun May 14 23:44:44 2017
##################################################
...
class basic_encdec_soft(gr.top_block, Qt.QWidget):

    def __init__(self, frame_size=60, puncpat='11'):
        gr.top_block.__init__(self, "Basic Encdec Soft")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basic Encdec Soft")
        ...
        self.settings = Qt.QSettings("GNU Radio", "basic_encdec_soft")
...
def main(top_block_cls=basic_encdec_soft, options=None):
    if options is None:
