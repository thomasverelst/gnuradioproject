...
# Title: Packetizer
# Generated: Fri Mar 17 21:58:34 2017
##################################################
...
class packetizer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.header_formatter = header_formatter = digital.packet_header_default(4, "packet_len", "packet_num", 1)
        self.gap = gap = 20000
        self.freq_offset = freq_offset = 0
        self.constel_payload = constel_payload = digital.constellation_calcdist(([-1-1j, -1+1j, 1+1j, 1-1j]), ([0, 1, 3, 2]), 4, 1).base()
        self.constel_header = constel_header = digital.constellation_calcdist(([1,-1]), ([0,1]), 2, 1).base()
        ...
        self.qtgui_time_sink_x_0_1 = qtgui.time_sink_f(
        	...
        	"CorrnSync output", #name
        	2 #number of inputs
        )
        self.qtgui_time_sink_x_0_1.set_update_time(0.02)
        ...
        self.qtgui_const_sink_x_0_0 = qtgui.const_sink_c(
        	1024, #size
        	"Constellations after encoder", #name
        	1 #number of inputs
        )
        ...
        self.packetizr_packet_encoder_0 = packetizr.packet_encoder(sps, (preamble), constel_payload, constel_payload, 1, "packet_len")
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(4, 2*3.14/100.0, (rrc_taps), nfilts, 0, 1.0, 1)
        self.digital_packet_headergenerator_bb_0 = digital.packet_headergenerator_bb(header_formatter, "packet_len")
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(2*3.14/100.0, 4, False)
        ...
        self.connect((self.blocks_complex_to_imag_0, 0), (self.qtgui_time_sink_x_0, 1))    
        self.connect((self.blocks_complex_to_imag_0_1, 0), (self.qtgui_time_sink_x_0_1, 1))    
        self.connect((self.blocks_complex_to_mag_1, 0), (self.qtgui_time_sink_x_1, 0))    
        self.connect((self.blocks_complex_to_real_0, 0), (self.qtgui_time_sink_x_0, 0))    
        self.connect((self.blocks_complex_to_real_0_1, 0), (self.qtgui_time_sink_x_0_1, 0))    
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.digital_packet_headergenerator_bb_0, 0))    
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.packetizr_packet_encoder_0, 1))    
        ...
        self.connect((self.digital_correlate_and_sync_cc_0, 0), (self.blocks_complex_to_imag_0_1, 0))    
        self.connect((self.digital_correlate_and_sync_cc_0, 1), (self.blocks_complex_to_mag_1, 0))    
        self.connect((self.digital_correlate_and_sync_cc_0, 0), (self.blocks_complex_to_real_0_1, 0))    
        self.connect((self.digital_correlate_and_sync_cc_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))    
        self.connect((self.digital_costas_loop_cc_0, 0), (self.qtgui_const_sink_x_0, 0))    
        self.connect((self.digital_packet_headergenerator_bb_0, 0), (self.packetizr_packet_encoder_0, 0))    
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.digital_costas_loop_cc_0, 0))    
        self.connect((self.packetizr_packet_encoder_0, 0), (self.pfb_arb_resampler_xxx_0, 0))    
        self.connect((self.packetizr_packet_encoder_0, 0), (self.qtgui_const_sink_x_0_0, 0))    
