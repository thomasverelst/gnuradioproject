...
# Title: Chain Custom 4
# Generated: Thu May 25 10:58:36 2017
##################################################
...
class chain_custom_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Chain Custom 4")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Chain Custom 4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "chain_custom_4")
...
def main(top_block_cls=chain_custom_4, options=None):
