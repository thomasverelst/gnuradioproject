...
# Title: Custom Encdec Soft
# Generated: Thu May 11 18:35:45 2017
##################################################
...
class custom_encdec_soft(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Custom Encdec Soft")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Custom Encdec Soft")
        ...
        self.settings = Qt.QSettings("GNU Radio", "custom_encdec_soft")
        ...
        self._packet_len_range = Range(1, 4096, 1, 128, 100)
        self._packet_len_win = RangeWidget(self._packet_len_range, self.set_packet_len, 'Packet Length', "slider", int)
        self.top_layout.addWidget(self._packet_len_win)
        self.qtgui_time_sink_x_1_0_0 = qtgui.time_sink_f(
        	512, #size
        	samp_rate, #samp_rate
        	"Decoder correct soft ouput", #name
        	1 #number of inputs
        )
        ...
        self.blocks_stream_to_tagged_stream_0_1 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, packet_len, "packet_len")
        self.blocks_repack_bits_bb_0_0 = blocks.repack_bits_bb(1, 2, '', False, gr.GR_MSB_FIRST)
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(2, 8, "packet_len", False, gr.GR_LSB_FIRST)
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_uchar_to_float_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.blocks_repack_bits_bb_0, 0))
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.blocks_uchar_to_float_0_1, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0_1, 0), (self.blocks_uchar_to_float_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_0_0, 0), (self.qtgui_time_sink_x_1, 1))
        self.connect((self.blocks_uchar_to_float_0_1, 0), (self.qtgui_time_sink_x_1_0_0, 0))
        self.connect((self.digital_binary_slicer_fb_0, 0), (self.blocks_repack_bits_bb_0_0, 0))
        self.connect((self.packetizr_packet_decoder_0, 0), (self.digital_binary_slicer_fb_0, 0))
...
def main(top_block_cls=custom_encdec_soft, options=None):
