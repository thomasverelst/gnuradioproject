...
# Title: Endec Basic
# Generated: Sat Jun  3 23:42:50 2017
##################################################
...
class endec_basic(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.packetizer_preamble_header_payload_demux_0 =  packetizer.preamble_header_payload_demux(32/constel_header.bits_per_symbol(), 1, 0, "packet_len", "packet_len", True, gr.sizeof_gr_complex, "rx_time", samp_rate, (), 0, len(preamble), constel_payload.bits_per_symbol())
        ...
        self.blocks_tagged_stream_align_0_0 = blocks.tagged_stream_align(gr.sizeof_float*1, 'packet_len')
        self.blocks_tagged_stream_align_0 = blocks.tagged_stream_align(gr.sizeof_float*1, 'packet_len')
        ...
        self.connect((self.blocks_char_to_float_1_0, 0), (self.blocks_tagged_stream_align_0_0, 0))
        ...
        self.connect((self.blocks_tagged_stream_align_0, 0), (self.digital_binary_slicer_fb_0, 0))
        self.connect((self.blocks_tagged_stream_align_0_0, 0), (self.qtgui_time_sink_x_1, 2))
        ...
        self.connect((self.digital_constellation_soft_decoder_cf_0, 0), (self.blocks_tagged_stream_align_0, 0))
