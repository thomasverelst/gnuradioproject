...
# Title: Encdec Custom
# Generated: Mon Jun 12 13:46:30 2017
##################################################
...
class encdec_custom(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.packetizer_packet_encoder_0 = packetizer.packet_encoder((preamble), constel_header.base(), constel_payload.base(), header_formatter.base(), False, False, "packet_len", 100, False, 1)
        self.packetizer_packet_decoder_0_0 = packetizer.packet_decoder((preamble), constel_header.base(), constel_payload.base(), header_formatter.base(), samp_rate, False, False, "packet_len", False, False, False, 1)
        self.packetizer_packet_decoder_0 = packetizer.packet_decoder((preamble), constel_header.base(), constel_payload.base(), header_formatter.base(), samp_rate, False, False, "packet_len", False, True, False, 1)
