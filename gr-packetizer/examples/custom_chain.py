...
# Title: Custom Chain
# Generated: Sun May 21 15:55:23 2017
##################################################
...
class custom_chain(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Custom Chain")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Custom Chain")
        ...
        self.settings = Qt.QSettings("GNU Radio", "custom_chain")
        ...
        self.packetizer_corr_est_cc_0 = packetizer.corr_est_cc((shaped_preamble), 4, 100, 0.999999, 0)
...
def main(top_block_cls=custom_chain, options=None):
