...
# Generated: Mon Jun 12 13:29:38 2017
##################################################
...
class chain_rx_debug(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Chain Rx Debug")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Chain Rx Debug")
        ...
        self.settings = Qt.QSettings("GNU Radio", "chain_rx_debug")
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 8,0,1,2)
        ...
        self.packetizer_tagged_stream_fix_0 = packetizer.tagged_stream_fix("packet_len",numpy.float32)
...
def main(top_block_cls=chain_rx_debug, options=None):
