...
# Title: Test Corr Est
# Generated: Sat May 20 23:19:25 2017
##################################################
...
class test_corr_est(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.packetizer_corr_est_cc_0 = packetizer.corr_est_cc((modulated_sync_word), 4, 1, 0.999999, 0.5)
        ...
        self.connect((self.blocks_null_source_1, 0), (self.qtgui_time_sink_x_1, 1))
        self.connect((self.blocks_null_source_1, 0), (self.qtgui_time_sink_x_1, 2))
