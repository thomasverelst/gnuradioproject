...
# Generated: Wed Mar  8 20:33:24 2017
##################################################
...
class test_corr_and_sync(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blks2_packet_encoder_0 = grc_blks2.packet_mod_b(grc_blks2.packet_encoder(
        		...
        		bits_per_symbol=1,
        		preamble="101001100111001010010000101110010101001011",
        		access_code="",
        		pad_for_usrp=True,
        	),
        	payload_length=0,
        ...
        self.connect((self.blks2_packet_encoder_0, 0), (self.blocks_char_to_float_1_0, 0))    
