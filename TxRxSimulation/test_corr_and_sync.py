...
# Generated: Sat Mar  4 21:35:26 2017
##################################################
...
class test_corr_and_sync(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.phase = phase = 0
        self.payload_size = payload_size = 256
        self.noise = noise = 0
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_0_win, 8,0,1,2)
        ...
        self.blocks_stream_mux_0_0_0 = blocks.stream_mux(gr.sizeof_gr_complex*1, (len(preamble)/8*32,payload_size*5))
        ...
        self.connect((self.blocks_stream_mux_0_0_0, 0), (self.blocks_throttle_0, 0))    
        ...
        self.connect((self.digital_constellation_modulator_0, 0), (self.blocks_complex_to_float_0_0, 0))    
        self.connect((self.digital_constellation_modulator_0, 0), (self.blocks_stream_mux_0_0_0, 0))    
        self.connect((self.digital_constellation_modulator_0_0, 0), (self.blocks_stream_mux_0_0_0, 1))    
