...
# Title: Tx Rx Sim
# Generated: Sun Mar 12 16:15:19 2017
##################################################
...
class tx_rx_sim(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tx Rx Sim")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx Rx Sim")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_rx_sim")
        ...
        self._delay_range = Range(0, 200, 1, 63, 200)
        ...
        self.connect((self.digital_psk_demod_0, 0), (self.blks2_error_rate_0, 0))    
